...
rc_file_name=".EtherFangrc"
alternative_rc_file_name="EtherFangrc"
...
#Tmux vars
EtherFang_uid=""
session_name="EtherFang"
tmux_main_window="EtherFang-Main"
no_hardcore_exit=0
...
function language_strings_handling_messages() {
	...
	language_strings_try_to_download["ENGLISH"]="EtherFang will try to download the language strings file..."
	language_strings_try_to_download["SPANISH"]="EtherFang intentará descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="EtherFang va essayer de télécharger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="EtherFang intentarà descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O EtherFang tentará baixar o arquivo de tradução..."
	language_strings_try_to_download["RUSSIAN"]="EtherFang попытается загрузить языковой файл..."
	language_strings_try_to_download["GREEK"]="Το EtherFang θα προσπαθήσει να κατεβάσει το αρχείο γλωσσών..."
	language_strings_try_to_download["ITALIAN"]="EtherFang cercherá di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="EtherFang spróbuje pobrać plik tłumaczeń..."
	language_strings_try_to_download["GERMAN"]="EtherFang wird versuchen, die Übersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="EtherFang çeviri dosyasını indirmeye çalışacak..."
	language_strings_try_to_download["ARABIC"]="سيحاول EtherFang تنزيل ملف سلاسل اللغة ..."
	language_strings_try_to_download["CHINESE"]="EtherFang 将尝试下载语言支持文件..."
	...
	language_strings_first_time["ENGLISH"]="If you are seeing this message after an automatic update, don't be scared! It's probably because EtherFang has different file structure since version 6.1. It will be automatically fixed"
	language_strings_first_time["SPANISH"]="Si estás viendo este mensaje tras una actualización automática, ¡no te asustes! probablemente es porque a partir de la versión 6.1 la estructura de ficheros de EtherFang ha cambiado. Se reparará automáticamente"
	language_strings_first_time["FRENCH"]="Si vous voyez ce message après une mise à jour automatique ne vous inquiétez pas! A partir de la version 6.1 la structure de fichier d'EtherFang a changé. L'ajustement se fera automatiquement"
	language_strings_first_time["CATALAN"]="Si estàs veient aquest missatge després d'una actualització automàtica, no t'espantis! probablement és perquè a partir de la versió 6.1 l'estructura de fitxers de EtherFang ha canviat. Es repararà automàticament"
	language_strings_first_time["PORTUGUESE"]="Se você está vendo esta mensagem depois de uma atualização automática, não tenha medo! A partir da versão 6.1 da estrutura de arquivos do EtherFang mudou. Isso será corrigido automaticamente"
	language_strings_first_time["RUSSIAN"]="Если вы видите это сообщение после автоматического обновления, не переживайте! Вероятно, это объясняется тем, что, начиная с версии 6.1, EtherFang имеет другую структуру файлов. Проблема будет разрешена автоматически"
	language_strings_first_time["GREEK"]="Εάν βλέπετε αυτό το μήνυμα μετά από κάποια αυτόματη ενημέρωση, μην τρομάξετε! Πιθανόν είναι λόγω της διαφορετικής δομής του EtherFang μετά από την έκδοση 6.1. Θα επιδιορθωθεί αυτόματα"
	language_strings_first_time["ITALIAN"]="Se stai vedendo questo messaggio dopo un aggiornamento automatico, niente panico! probabilmente è perché a partire dalla versione 6.1 é cambiata la struttura dei file di EtherFang. Sarà riparato automaticamente"
	language_strings_first_time["POLISH"]="Jeśli widzisz tę wiadomość po automatycznej aktualizacji, nie obawiaj się! To prawdopodobnie dlatego, że w wersji 6.1 zmieniła się struktura plików EtherFang. Naprawi się automatycznie"
	language_strings_first_time["GERMAN"]="Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von EtherFang geändert wurde. Es wird automatisch repariert"
	language_strings_first_time["TURKISH"]="Otomatik bir güncellemeden sonra bu mesajı görüyorsanız, korkmayın! muhtemelen 6.1 sürümünden itibaren EtherFang dosya yapısı değişmiştir. Otomatik olarak tamir edilecektir"
	language_strings_first_time["ARABIC"]="إذا كنت ترى هذه الرسالة بعد التحديث التلقائي ، فلا تخف! ربما يرجع السبب في ذلك إلى أن EtherFang له بنية ملفات مختلفة منذ الإصدار 6.1. سيتم إصلاحه تلقائيًا "
	language_strings_first_time["CHINESE"]="如果您在自动更新后看到此消息，请不要害怕！这可能是因为 EtherFang 从 6.1 版本开始有不同的文件结构。会自动修复"

	declare -gA language_strings_exiting
	language_strings_exiting["ENGLISH"]="Exiting EtherFang script v${EtherFang_version} - See you soon! *_*"
	language_strings_exiting["SPANISH"]="Saliendo de EtherFang script v${EtherFang_version} - Nos vemos pronto! *_*"
	language_strings_exiting["FRENCH"]="Fermeture du script EtherFang v${EtherFang_version} - A bientôt! *_*"
	language_strings_exiting["CATALAN"]="Sortint de EtherFang script v${EtherFang_version} - Ens veiem aviat! *_*"
	language_strings_exiting["PORTUGUESE"]="Saindo do script EtherFang v${EtherFang_version} - Até breve! *_*"
	language_strings_exiting["RUSSIAN"]="Выход из скрипта EtherFang v${EtherFang_version} - До встречи! *_*"
	language_strings_exiting["GREEK"]="Κλείσιμο του EtherFang v${EtherFang_version} - Αντίο *_*"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script EtherFang v${EtherFang_version} - A presto! *_*"
	language_strings_exiting["POLISH"]="Wyjście z skryptu EtherFang v${EtherFang_version} - Do zobaczenia wkrótce! *_*"
	language_strings_exiting["GERMAN"]="Sie verlassen EtherFang v${EtherFang_version} - Bis bald! *_*"
	language_strings_exiting["TURKISH"]="EtherFang yazılımından çıkış yapılıyor v${EtherFang_version} - Yakında görüşürüz! *_*"
	language_strings_exiting["ARABIC"]="الخروج من البرنامج EtherFang v${EtherFang_version}- نراكم قريبًا! *_*"
	language_strings_exiting["CHINESE"]="退出 EtherFang 脚本 v${EtherFang_version} - 待会见！ *_*"
...
function option_toggle() {
	...
	case "${option_var_name}" in
		"ETHERFANG_BASIC_COLORS")
			remap_colors
		;;
		"ETHERFANG_EXTENDED_COLORS")
			initialize_extended_colorized_output
		;;
		"ETHERFANG_5GHZ_ENABLED")
...
function debug_print() {
	...
	if "${ETHERFANG_DEBUG_MODE:-true}"; then
...
function special_text_missed_optional_tool() {
	...
	if ! "${ETHERFANG_DEVELOPMENT_MODE:-false}"; then
...
function get_5ghz_band_info_from_phy_interface() {
	...
	if iw phy "${1}" channels 2> /dev/null | grep -Ei "5180(\.0)? MHz" > /dev/null; then
		if "${ETHERFANG_5GHZ_ENABLED:-true}"; then
			return 0
		else
			return 2
		fi
	...
	case ${option_selected} in
		...
		2)
			if "${ETHERFANG_AUTO_UPDATE:-true}"; then
				ask_yesno 457 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_AUTO_UPDATE"; then
						echo
		...
		3)
			if "${ETHERFANG_SKIP_INTRO:-true}"; then
				ask_yesno 569 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_SKIP_INTRO"; then
						echo
		...
		4)
			if "${ETHERFANG_BASIC_COLORS:-true}"; then
				ask_yesno 558 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_BASIC_COLORS"; then
						echo
		...
		5)
			...
			if "${ETHERFANG_EXTENDED_COLORS:-true}"; then
				ask_yesno 462 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_EXTENDED_COLORS"; then
						echo
		...
		6)
			if "${ETHERFANG_AUTO_CHANGE_LANGUAGE:-true}"; then
				ask_yesno 469 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_AUTO_CHANGE_LANGUAGE"; then
						echo
		...
		7)
			if "${ETHERFANG_SILENT_CHECKS:-true}"; then
				ask_yesno 577 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_SILENT_CHECKS"; then
						echo
		...
		8)
			if "${ETHERFANG_PRINT_HINTS:-true}"; then
				ask_yesno 586 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_PRINT_HINTS"; then
						echo
		...
		9)
			if "${ETHERFANG_5GHZ_ENABLED:-true}"; then
				ask_yesno 596 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_5GHZ_ENABLED"; then
						echo
		...
		10)
			if [ "${ETHERFANG_WINDOWS_HANDLING}" = "xterm" ]; then
				ask_yesno 657 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(ETHERFANG_WINDOWS_HANDLING)=(xterm):\1=tmux:" "${rc_path}" 2> /dev/null
					echo
				...
				ask_yesno 658 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(ETHERFANG_WINDOWS_HANDLING)=(tmux):\1=xterm:" "${rc_path}" 2> /dev/null
					echo
					language_strings "${language}" 620 "yellow"
					language_strings "${language}" 115 "read"
				fi
		...
		12)
			...
			if [ "${yesno}" = "y" ]; then
				if option_toggle "ETHERFANG_PLUGINS_ENABLED" "required_reboot"; then
					echo
					language_strings "${language}" 620 "yellow"
				else
					echo
		...
		13)
			if "${ETHERFANG_FORCE_NETWORK_MANAGER_KILLING:-true}"; then
				ask_yesno 692 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_FORCE_NETWORK_MANAGER_KILLING"; then
						echo
		...
		14)
			if "${ETHERFANG_EVIL_TWIN_ESSID_STRIPPING:-true}"; then
				ask_yesno 767 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "ETHERFANG_EVIL_TWIN_ESSID_STRIPPING"; then
						echo
			...
			if [ "${yesno}" = "y" ]; then
				...
				if [ "${language}" = "${current_permanent_language}" ]; then
					...
					if "${ETHERFANG_AUTO_CHANGE_LANGUAGE:-true}"; then
						...
						option_toggle "ETHERFANG_AUTO_CHANGE_LANGUAGE"
					fi
...
function enterprise_certificates_check() {
	...
	if [ "${ETHERFANG_WINDOWS_HANDLING}" = "tmux" ]; then
...
function set_wep_key_script() {
	...
	cat >&8 <<-EOF
		...
		ETHERFANG_WINDOWS_HANDLING="${ETHERFANG_WINDOWS_HANDLING}"
		...
		function manage_output() {
			...
			case "\${ETHERFANG_WINDOWS_HANDLING}" in
				"tmux")
					local tmux_color
					tmux_color=""
...
function mdk_version_toggle() {
	...
	if [ "${ETHERFANG_MDK_VERSION}" = "mdk3" ]; then
		sed -ri "s:(ETHERFANG_MDK_VERSION)=(mdk3):\1=mdk4:" "${rc_path}" 2> /dev/null
		ETHERFANG_MDK_VERSION="mdk4"
	else
		sed -ri "s:(ETHERFANG_MDK_VERSION)=(mdk4):\1=mdk3:" "${rc_path}" 2> /dev/null
		ETHERFANG_MDK_VERSION="mdk3"
	fi
...
function print_options() {
	...
	if [ "${ETHERFANG_WINDOWS_HANDLING}" = "xterm" ]; then
		if grep -q "ETHERFANG_WINDOWS_HANDLING=tmux" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 618 "blue"
	else
		if grep -q "ETHERFANG_WINDOWS_HANDLING=xterm" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
	...
	reboot_required_text=""
	if "${ETHERFANG_PLUGINS_ENABLED:-true}"; then
		if grep -q "ETHERFANG_PLUGINS_ENABLED=false" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 653 "blue"
	else
		if grep -q "ETHERFANG_PLUGINS_ENABLED=true" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
...
function clean_env_vars() {
	...
	unset ETHERFANG_AUTO_UPDATE ETHERFANG_SKIP_INTRO ETHERFANG_BASIC_COLORS ETHERFANG_EXTENDED_COLORS ETHERFANG_AUTO_CHANGE_LANGUAGE ETHERFANG_SILENT_CHECKS ETHERFANG_PRINT_HINTS ETHERFANG_5GHZ_ENABLED ETHERFANG_FORCE_IPTABLES ETHERFANG_FORCE_NETWORK_MANAGER_KILLING ETHERFANG_MDK_VERSION ETHERFANG_PLUGINS_ENABLED ETHERFANG_EVIL_TWIN_ESSID_STRIPPING ETHERFANG_DEVELOPMENT_MODE ETHERFANG_DEBUG_MODE ETHERFANG_WINDOWS_HANDLING
}
...
function control_routing_status() {
	...
	if [ "${1}" = "start" ]; then
		readarray -t ETHERFANG_PIDS 2> /dev/null < <(cat < "${system_tmpdir}${ag_orchestrator_file}" 2> /dev/null)
		for item in "${ETHERFANG_PIDS[@]}"; do
...
function clean_tmpfiles() {
	...
	if [ "${1}" = "exit_script" ]; then
		...
		if is_last_EtherFang_instance; then
...
function clean_routing_rules() {
	...
	if is_last_EtherFang_instance && [[ -n "${system_tmpdir}${routing_tmp_file}" ]]; then
...
function prepare_iptables_nftables() {
	...
	if [ "${iptables_nftables}" -eq 1 ]; then
		"${iptables_cmd}" add table ip filter_"${EtherFang_instance_name}"
		"${iptables_cmd}" add chain ip filter_"${EtherFang_instance_name}" forward_"${EtherFang_instance_name}" '{type filter hook forward priority 0; policy accept;}'
		"${iptables_cmd}" add chain ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" '{type filter hook input priority 0;}'
		"${iptables_cmd}" add table ip nat_"${EtherFang_instance_name}"
		"${iptables_cmd}" add chain ip nat_"${EtherFang_instance_name}" prerouting_"${EtherFang_instance_name}" '{type nat hook prerouting priority -100;}'
		"${iptables_cmd}" add chain ip nat_"${EtherFang_instance_name}" postrouting_"${EtherFang_instance_name}" '{type nat hook postrouting priority 100;}'
	else
		"${iptables_cmd}" -P FORWARD ACCEPT
		"${iptables_cmd}" -t filter -N input_"${EtherFang_instance_name}"
		"${iptables_cmd}" -A INPUT -j input_"${EtherFang_instance_name}"
		"${iptables_cmd}" -t filter -N forward_"${EtherFang_instance_name}"
		"${iptables_cmd}" -A FORWARD -j forward_"${EtherFang_instance_name}"
	fi
}
...
function clean_this_instance_iptables_nftables() {
	...
	if [ "${iptables_nftables}" -eq 1 ]; then
		"${iptables_cmd}" delete table filter_"${EtherFang_instance_name}" 2> /dev/null
		"${iptables_cmd}" delete table nat_"${EtherFang_instance_name}" 2> /dev/null
	else
		"${iptables_cmd}" -D INPUT -j input_"${EtherFang_instance_name}" 2> /dev/null
		"${iptables_cmd}" -D FORWARD -j forward_"${EtherFang_instance_name}" 2> /dev/null
		"${iptables_cmd}" -F input_"${EtherFang_instance_name}" 2> /dev/null
		"${iptables_cmd}" -F forward_"${EtherFang_instance_name}" 2> /dev/null
		"${iptables_cmd}" -X input_"${EtherFang_instance_name}" 2> /dev/null
		"${iptables_cmd}" -X forward_"${EtherFang_instance_name}" 2> /dev/null
	fi
}
...
function clean_initialize_iptables_nftables() {
	...
	if [ "${1}" = "start" ]; then
		if [[ "${clean_all_iptables_nftables}" -eq 1 ]] && is_first_routing_modifier_EtherFang_instance; then
...
#Detect number of the alive EtherFang instances and set the next one if apply
function instance_setter() {
	...
	if [ "${create_dir}" -eq 1 ]; then
		local dir_number="1"
		EtherFang_instance_name="ag${dir_number}"
		local EtherFang_instance_dir="${EtherFang_instance_name}/"

		if [ -d "${system_tmpdir}${EtherFang_instance_dir}" ]; then
			while true; do
				dir_number=$((dir_number + 1))
				EtherFang_instance_name="ag${dir_number}"
				EtherFang_instance_dir="${EtherFang_instance_name}/"
				if [ ! -d "${system_tmpdir}${EtherFang_instance_dir}" ]; then
					break
				fi
			done
		...
		tmpdir="${system_tmpdir}${EtherFang_instance_dir}"
	...
	if [ ! -f "${system_tmpdir}${ag_orchestrator_file}" ]; then
		...
		for item in "${ETHERFANG_PIDS[@]}"; do
			...
			if ps -p "${agpid}" > /dev/null 2>&1; then
				EtherFang_pid_alive=1
				break
			fi
		done

		if [ "${EtherFang_pid_alive}" -eq 0 ]; then
...
#Detect and return the number of EtherFang running instances
function detect_running_instances() {

	debug_print

	EtherFang_running_instances_counter=1

	readarray -t ETHERFANG_PIDS 2> /dev/null < <(cat < "${system_tmpdir}${ag_orchestrator_file}" 2> /dev/null)
	for item in "${ETHERFANG_PIDS[@]}"; do
		[[ "${item}" =~ ^(et)?([0-9]+)(rs[0-1])?$ ]] && agpid="${BASH_REMATCH[2]}"
		if [[ "${agpid}" != "${BASHPID}" ]] && ps -p "${agpid}" > /dev/null 2>&1; then
			EtherFang_running_instances_counter=$((EtherFang_running_instances_counter + 1))
		fi
	done

	return "${EtherFang_running_instances_counter}"
}

#Check if this instance is the first one modifying routing state
function is_first_routing_modifier_EtherFang_instance() {
...
#Check if this instance is the last EtherFang instance running
function is_last_EtherFang_instance() {
...
function set_std_internet_routing_rules() {
	...
	if [ "${et_mode}" = "et_captive_portal" ]; then
		if [ "${iptables_nftables}" -eq 1 ]; then
			"${iptables_cmd}" add rule ip nat_"${EtherFang_instance_name}" prerouting_"${EtherFang_instance_name}" iifname "${interface}" tcp dport "${www_port}" counter dnat to "${et_ip_router}:${www_port}"
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" tcp dport "${www_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" tcp dport "${https_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" udp dport "${dns_port}" counter accept
		else
			"${iptables_cmd}" -t nat -A PREROUTING -p tcp -i "${interface}" --dport "${www_port}" -j DNAT --to-destination "${et_ip_router}:${www_port}"
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p tcp -i "${interface}" --destination-port "${www_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p tcp -i "${interface}" --destination-port "${https_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p udp -i "${interface}" --destination-port "${dns_port}" -j ACCEPT
		fi
	elif [ "${et_mode}" = "et_sniffing_sslstrip2" ]; then
		if [ "${iptables_nftables}" -eq 1 ]; then
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" tcp dport "${bettercap_proxy_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" udp dport "${bettercap_dns_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${loopback_interface}" counter accept
		else
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p tcp -i "${interface}" --destination-port "${bettercap_proxy_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p udp -i "${interface}" --destination-port "${bettercap_dns_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -i "${loopback_interface}" -j ACCEPT
		fi
		...
		if [ "${iptables_nftables}" -eq 1 ]; then
			...
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" udp dport "${bettercap_dns_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${loopback_interface}" counter accept
			"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" tcp dport "${beef_port}" counter accept
		else
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p tcp -i "${interface}" --destination-port "${bettercap_proxy_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p udp -i "${interface}" --destination-port "${bettercap_dns_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -i "${loopback_interface}" -j ACCEPT
			"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -p tcp -i "${interface}" --destination-port "${beef_port}" -j ACCEPT
		fi
	fi

	if [ "${et_mode}" != "et_captive_portal" ]; then
		if [ "${iptables_nftables}" -eq 1 ]; then
			"${iptables_cmd}" add rule nat_"${EtherFang_instance_name}" postrouting_"${EtherFang_instance_name}" ip saddr "${et_ip_range}/${std_c_mask_cidr}" oifname "${internet_interface}" counter masquerade
		else
	...
	if [ "${iptables_nftables}" -eq 1 ]; then
		"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" iifname "${interface}" ip daddr "${et_ip_router}/${ip_mask_cidr}" icmp type echo-request ct state new,related,established counter accept
		"${iptables_cmd}" add rule ip filter_"${EtherFang_instance_name}" input_"${EtherFang_instance_name}" ip daddr "${et_ip_router}/${ip_mask_cidr}" counter drop
	else
		"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -i "${interface}" -p icmp --icmp-type 8 -d "${et_ip_router}/${ip_mask}" -m state --state NEW,ESTABLISHED,RELATED -j ACCEPT
		"${iptables_cmd}" -A input_"${EtherFang_instance_name}" -d "${et_ip_router}/${ip_mask}" -j DROP
	fi
	sleep 2
}
...
'
		...
		if [ "${cp_vendor_detected}" = "0" ]; then
			...
			captive_portal_brand="EtherFang_default"
...
function set_beef_config() {
	...
	{
	echo -e "beef:"
	echo -e "    version: 'EtherFang integrated'"
	echo -e "    debug: false"
...
#Rewrite EtherFang script in a polymorphic way adding custom beef location to array to get persistence
...
function credits_option() {
        ...
        echo
        # V1S1TOR ASCII ART REPLACEMENT - Infused with Purple and Green!
        sleep 0.15 && echo -e "${purple_color}                       
        sleep 0.15 && echo -e "${green_color} 
        sleep 0.15 && echo -e "${purple_color}
		sleep 0.15 && echo -e "${green_color}
        sleep 0.15 && echo -e "${purple_color}
        sleep 0.15 && echo
...
function iptables_nftables_detection() {
	...
	if ! "${ETHERFANG_FORCE_IPTABLES:-false}"; then
...
function set_script_paths() {
	...
	plugins_paths=(
					...
					"${user_homedir}.EtherFang/${plugins_dir}"
				)
}
...
function update_options_config_file() {
	...
	case "${1}" in
		"getdata")
			readarray -t OPTION_VARS < <(grep "ETHERFANG_" "${rc_path}" 2> /dev/null)
		;;
		"writedata")
			local option_name
			local option_value
...
function check_root_permissions() {
	...
	if [ "${user}" = "root" ]; then
		if ! "${ETHERFANG_SILENT_CHECKS:-false}"; then
			echo
...
function print_intro() {
        ...
        # ETHERFANG ASCII ART REPLACEMENT - Infused with Purple and Green!
        sleep 0.15 && echo -e "${green_color}   _____ _____ _   _ _____ _  _   _____ _  ___   ____ "
        sleep 0.15 && echo -e "${purple_color} | ____|_   _| | | | ____| || | |  ___/ |/ _ \ / ___|"
        sleep 0.15 && echo -e "${green_color}  |  _|   | | | |_| |  _| | || |_| |_  | | (_) | |  _ "
        sleep 0.15 && echo -e "${purple_color} | |___  | | |  _  | |___|__   _|  _| | |\__, | |_| |"
        sleep 0.15 && echo -e "${green_color}  |_____| |_| |_| |_|_____|  |_| |_|   |_|  /_/ \____|"
        sleep 0.15 && echo -e "${purple_color}                  BY FAHAD KHAN"
        sleep 5 && echo
        language_strings "${language}" 228 "green"
        print_animated_howling_fang
        sleep 1
}
#Generate the frames of the animated ascii art howling fang
function howling_fang() {

        debug_print

        # This function is now empty. The actual static display is replaced by the animation function itself.
        # This prevents the fang from being displayed statically inside the intro.
        case ${1} in
                1)
                        # Static fang removed.
                ;;
...
function animated_howling_fang_window_correction() {

        debug_print

        local -a colors=(32 35) # Green (32) and Purple (35)
        local stars=( "." "+" "*" "o" "∙" )
        local color_index=0
        local color_change_interval=10 # Faster color change for dynamic effect
        local color_change_counter=0

        # The magnificent COSMIC VESSEL (Saucer)
        local shape=(
                "WWWWWWWWWWWWWWWWWWWWWWWWNXKOkkxdddddxxkO0KNWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWWWWWWWWWWWNX0OkxdoooooooooooooooooodkO0XNWWWWWWWWWWWWW"
                "WWWWWWWWWWWWWWNKOxdooooooooooooooooooooooooooooooxO0XWWWWWWWWW"
                "WWWWWWWWWWWXOxoooooooodxkO0KXXNNNNNNNNXKK0OxdooooooooxOXWWWWWW"
                "WWWWWWWWWKxoooooooxO0XWWWWWWWWWWWWWWWWWWWWWWWXKOxooooooox0NWWW"
                "WWWWWWN0dooooook0NWWWWWWWWWNXXKKKKKKKXXNWWWWWWWWWNKkoooooodONW"
                "WWWWW0dooooox0NWWWWWWWWWX0OxdooooooooooooodxO0XNWWWWWWN0xooooo"
                "WWWWWOdoookKWWWWWWX0kdooooooooooooooooooooooooxOXWWWWWWXOooook"
                "WWWWWWN0OXWWWWWN0xooooooodxkO0KKXXXXK00OxdooooooodONWWWWWNO0NW"
                "WWWWWWWWWWWWWNOdooooook0XNWWWWWWWWWWWWWWWWX0kdooooooONWWWWWWWW"
                "WWWWWWWWWWWWWdooooox0NWWWWK0WWNKKKKXXNWWWWWWWNKkooooooXWWWWWWW"
                "WWWWWWWWWWWWWN0dokXWWWWWOc':WW0oooooooxk0XWWWWWWXkookXWWWWWWWW"
                "WWWWWWWWWWWWWWWWNWWWWWKl''''kWXoooooooooooxOXWWWWWNNWWWWWWWWWW"
                "WWWWWWWWWWWWWWWWWWWWWO,''''',KWKXXXK0kdooooookNWWWWWWWWWWWWWWW"
                "WWWWWWWWWWWWWWWWWWNN0,''''''':XWWWWWWWWXOoooxKWWWWWWWWWWWWWWWW"
                "WWWWWWWWWWWWXOdl:;,,'''''''''',;:loxOKNWWN0XWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWWNOc'''''''''''''''''''''''''';lkNWWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWWNOd:''''''''''''''''''''';c:;''';OWWWWWWWWWWWWWWWWWWW"
                "WWWWWWW0o,'''''''''''''''''''''''',o0NKl'''oxk0XNWWWWWWWWWWWWW"
                "WWWWW0c'''''''''''''''''''''''''''''';;''''''''';:ldxO0XWWWWWW"
                "WWWNo,''''''''''''''''''''''''''''''''''''''''''''''''',dWWWWW"
                "WWX:''''''''''''''':,''''''''''''''''''''''''''''''''',oXWWWWW"
                "WX;'':;''''''''':xd;'''''''''''''''''',:loooolc:,''':dKWWWWWWW"
                "Wd,o0O'''''''''xNl''''''''''''''''''ckXWWWWWWWWNc:dKWWWWWWWWWW"
                "WkKWW:''''''''OWo'''''''''''''''''''cox0NWWWWWWXKWWWWWWWWWWWWW"
                "WWWWN,'''''''lW0'''''''''''''''''''''''';oONKkNWWWWWWWWWWWWWWW"
                "WWWWW;'''''''kWd''''''''''''''':oxxdoc,'''','oWWWWWWWWWWWWWWWW"
                "WWWWWk'''''''kWd'''''''''''''lXWWWWWWWNOd:,cOWWWWWWWWWWWWWWWWW"
                "WWWWWWx''''''cW0'''''',,'''''XWWWWWWWWWWWWNWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWO;'''''xWl''''',x'''''0WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWNx;''''xNl'''''kx,''':NWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWWWNOl,''lKk;''',00c''';kNWWWWWWWWWWWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWWWWWWN0xlcdOkl,',oK0o;'';dOXWWWWWWWWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWWWWWWWWWWWNKXWN0xl:okXKkdlccokKWWWWWWWWWWWWWWWWWWWWWWW"
                "WWWWWWWWWWWWWWWWWWWWWWWWWWWNK0NWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW"

                "                  PRESS ENTER KEY TO DIVE IN                  " 
        )
        local sw=70 # Maximum width of the logo (70 characters wide)
        local sh="${#shape[@]}" # 35 lines high

        # Movement and position variables (starting centered)
        local dx=0
        local vx=1
        local dy=0
        local vy=1
        local lx=0
        local ly=0
        local frame=0 # Retain frame counter for possible future use
 ...
 while true; do
                ...
                # Simple bounding box collision for movement
                (( dx < 0 )) && dx=0 && vx=1
                ...
                for ((i=0; i<cols * lines / 100; i++)); do
                        ...
                        # Print stars in dim white
                        printf "\033[%s;%sH\033[2;37m%s" "${sy}" "${sx}" "${star}"
                done

                # 2. Update Color Index (Shimmer effect)
                ...
                # 3. Erase Previous Logo Position
                # Uses the last known position (lx, ly) to clear the space
                for ((y=0; y<sh; y++)); do
                        (( ly + y < lines )) && printf "\033[%s;%sH%*s" "$((ly + y))" "$((lx + 1))" "${sw}" ""
                done

                # 4. Draw New Logo at (dx, dy) with current color
                printf "\033[1;%sm" "${current_color}" # Set bright color (either green or purple)
                for ((y=0; y<sh; y++)); do
                        if (( dy + y < lines )); then
                                local line="${shape[y]}"
                                # Print line, padded to sw width to ensure full overwrite
                                printf "\033[%s;%sH%-*s" "$((dy + y))" "$((dx + 1))" "${sw}" "${line}"
                        fi
                done
                printf "\033[0m" # Reset color

                # 5. Update position for next frame
                lx=${dx}
                ly=${dy}
                ((dx+=vx))
                ((dy+=vy))
...
#Print animated ascii art howling_fang
function print_animated_howling_fang() {

        debug_print

        # This now calls the animation function directly
        animated_howling_fang_window_correction
        sleep 0.1
}
...
function env_vars_initialization() {
	...
	ordered_options_env_vars=(
									"ETHERFANG_AUTO_UPDATE" #0
									"ETHERFANG_SKIP_INTRO" #1
									"ETHERFANG_BASIC_COLORS" #2
									"ETHERFANG_EXTENDED_COLORS" #3
									"ETHERFANG_AUTO_CHANGE_LANGUAGE" #4
									"ETHERFANG_SILENT_CHECKS" #5
									"ETHERFANG_PRINT_HINTS" #6
									"ETHERFANG_5GHZ_ENABLED" #7
									"ETHERFANG_FORCE_IPTABLES" #8
									"ETHERFANG_FORCE_NETWORK_MANAGER_KILLING" #9
									"ETHERFANG_MDK_VERSION" #10
									"ETHERFANG_PLUGINS_ENABLED" #11
									"ETHERFANG_EVIL_TWIN_ESSID_STRIPPING" #12
									"ETHERFANG_DEVELOPMENT_MODE" #13
									"ETHERFANG_DEBUG_MODE" #14
									"ETHERFANG_WINDOWS_HANDLING" #15
									)
...
#Detect if EtherFang is working inside a docker container
...
function initialize_extended_colorized_output() {
	...
	colorize=""
	if "${ETHERFANG_BASIC_COLORS:-true}" && "${ETHERFANG_EXTENDED_COLORS:-true}"; then
		if hash ccze 2> /dev/null; then
			colorize="| ccze -A"
		fi
	fi
...
#Kill tmux session started by EtherFang
...
function initialize_tmux() {
	...
	if [ "${1}" = "true" ]; then
		...
		EtherFang_uid="${BASHPID}"
	fi

	session_name="EtherFang${EtherFang_uid}"
...
#Starting point of EtherFang script inside newly created tmux session
function start_EtherFang_from_tmux() {

	debug_print

	tmux rename-window -t "${session_name}" "${tmux_main_window}"
	tmux send-keys -t "${session_name}:${tmux_main_window}" "clear;cd ${scriptfolder};bash ${scriptname} \"true\" \"${EtherFang_uid}\"" ENTER
	sleep 0.2
	if [ "${1}" = "normal" ]; then
...
#Create new tmux session exclusively for EtherFang
function create_tmux_session() {
	...
	if [ "${2}" = "true" ]; then
		...
		start_EtherFang_from_tmux "normal"
	else
		tmux new-session -d -s "${1}"
		start_EtherFang_from_tmux "nested"
	fi
}
...
function validate_plugin_requirements() {
	...
	if [ -n "${plugin_minimum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${plugin_minimum_ag_affected_version}" "${EtherFang_version}"; then
			return 1
		fi
	fi

	if [ -n "${plugin_maximum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${EtherFang_version}" "${plugin_maximum_ag_affected_version}"; then
			return 1
		fi
	fi
...
#Check for access to EtherFang repository
...
function autoupdate_check() {
	...
	if check_repository_access; then
		...
		EtherFang_last_version=$(timeout -s SIGTERM 15 curl -L ${urlscript_directlink} 2> /dev/null | grep "EtherFang_version=" | head -n 1 | cut -d "\"" -f 2)

		if [ -n "${EtherFang_last_version}" ]; then
			version_checked=1
		else
			http_proxy_detect
			if [ "${http_proxy_set}" -eq 1 ]; then

				EtherFang_last_version=$(timeout -s SIGTERM 15 curl --proxy "${http_proxy}" -L ${urlscript_directlink} 2> /dev/null | grep "EtherFang_version=" | head -n 1 | cut -d "\"" -f 2)
				if [ -n "${EtherFang_last_version}" ]; then
					version_checked=1
				else
					language_strings "${language}" 5 "yellow"
		...
		if [ "${version_checked}" -eq 1 ]; then
			if compare_floats_greater_than "${EtherFang_last_version}" "${EtherFang_version}"; then
...
function main() {
	...
	if [[ "${ETHERFANG_WINDOWS_HANDLING}" = "tmux" ]] && [[ "${tmux_error}" -eq 1 ]]; then
	...
	if ! "${ETHERFANG_DEVELOPMENT_MODE:-false}"; then
		if ! "${ETHERFANG_SKIP_INTRO:-false}"; then
			language_strings "${language}" 86 "title"
