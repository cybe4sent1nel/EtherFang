...
function language_strings_handling_messages() {
	...
	language_strings_exiting["ENGLISH"]="Exiting EtherFang script v${EtherFang_version} - See you soon! :)"
	language_strings_exiting["SPANISH"]="Saliendo de EtherFang script v${EtherFang_version} - Nos vemos pronto! :)"
	language_strings_exiting["FRENCH"]="Fermeture du script EtherFang v${EtherFang_version} - A bientôt! :)"
	language_strings_exiting["CATALAN"]="Sortint de EtherFang script v${EtherFang_version} - Ens veiem aviat! :)"
	language_strings_exiting["PORTUGUESE"]="Saindo do script EtherFang v${EtherFang_version} - Até breve! :)"
	language_strings_exiting["RUSSIAN"]="Выход из скрипта EtherFang v${EtherFang_version} - До встречи! :)"
	language_strings_exiting["GREEK"]="Κλείσιμο του EtherFang v${EtherFang_version} - Αντίο :)"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script EtherFang v${EtherFang_version} - A presto! :)"
	language_strings_exiting["POLISH"]="Wyjście z skryptu EtherFang v${EtherFang_version} - Do zobaczenia wkrótce! :)"
	language_strings_exiting["GERMAN"]="Sie verlassen EtherFang v${EtherFang_version} - Bis bald! :)"
	language_strings_exiting["TURKISH"]="EtherFang yazılımından çıkış yapılıyor v${EtherFang_version} - Yakında görüşürüz! :)"
	language_strings_exiting["ARABIC"]="الخروج من البرنامج EtherFang v${EtherFang_version}- نراكم قريبًا! :)"
	language_strings_exiting["CHINESE"]="退出 EtherFang 脚本 v${EtherFang_version} - 待会见！ :)"
...
# Function to print with color cycling
print_colored() {
    local text="$1"
    local colors=("$CYAN" "$LIGHT_CYAN" "$GREEN" "$LIGHT_GREEN" "$BLUE" "$LIGHT_BLUE")
    local color_index=0
...
animated_echo "║          Welcome to EtherFang Contributors Badge!              ║" "$LIGHT_GREEN"
animated_echo "║          Author & Maintainer: cybe4sent1nel                    ║" "$CYAN"
echo -e "${LIGHT_CYAN}╚════════════════════════════════════════════════════════════════════╝${RESET}"
echo ""

# Sleep before showing ASCII art
sleep 1

# ASCII Art with color animation
ascii_art="            _          _  _                  _   _            _ 
  ___ _   _| |__   ___| || |  ___  ___ _ __ | |_/ |_ __   ___| |
 / __| | | | '_ \\ / _ \\ || |_/ __|/ _ \\ '_ \\| __| | '_ \\ / _ \\ |
| (__| |_| | |_) |  __/__   _\\__ \\  __/ | | | |_| | | | |  __/ |
 \\___|\\__, |_.__/ \\___|  |_| |___|\\___| |_| |\\__|_|_| |_|\\___|_|
      |___/                                                     "

print_colored "$ascii_art"

# Sleep after ASCII art
sleep 1.5

# Echo messages with blue-green infusion
echo ""
animated_echo "🔷 Thank you for being a valued contributor!" "$CYAN"
sleep 0.8

animated_echo "🔶 Project: EtherFang - Ethical Network Pentesting Tool" "$GREEN"
sleep 0.8

animated_echo "🔷 Repository Status: ACTIVE" "$LIGHT_CYAN"
sleep 0.8

animated_echo "🔶 Community Driven: ENABLED" "$LIGHT_GREEN"
sleep 0.8

animated_echo "🔷 Your contributions make a difference!" "$BLUE"
sleep 1

echo ""
echo -e "${LIGHT_GREEN}╔════════════════════════════════════════════════════════════════════╗${RESET}"
animated_echo "║                    📌 IMPORTANT LINKS                           ║" "$CYAN"
echo -e "${LIGHT_GREEN}╚════════════════════════════════════════════════════════════════════╝${RESET}"

sleep 0.5
echo ""

# Display clickable links with animation
animated_echo "👤 Profile: https://github.com/cybe4sent1nel" "$LIGHT_CYAN"
echo -e "${YELLOW}   └─→ Click to visit my GitHub profile${RESET}"
sleep 0.6

echo ""
animated_echo "📦 Repository: https://github.com/cybe4sent1nel/EtherFang" "$LIGHT_GREEN"
echo -e "${YELLOW}   └─→ Click to visit the EtherFang repository${RESET}"
sleep 0.6

echo ""
animated_echo "📚 Wiki: https://github.com/cybe4sent1nel/EtherFang/wiki" "$LIGHT_BLUE"
echo -e "${YELLOW}   └─→ Click to visit the project wiki${RESET}"
sleep 0.8

echo ""
animated_echo "📧 Contact: fahad.64.in@gmail.com" "$MAGENTA"
echo -e "${YELLOW}   └─→ Reach out to the author & maintainer${RESET}"
sleep 0.8

echo ""
echo -e "${MAGENTA}════════════════════════════════════════════════════════════════════${RESET}"
animated_echo "💡 Want to contribute? Check out the repository and wiki!" "$CYAN"
animated_echo "📬 Questions? Email the maintainer: cybe4sent1nel" "$GREEN"
echo -e "${MAGENTA}════════════════════════════════════════════════════════════════════${RESET}"

sleep 0.5
echo ""
animated_echo "✓ Badge loaded successfully! System ready." "$LIGHT_CYAN"
echo ""
echo -e "${GREEN}🌟 Happy Contributing! 🌟${RESET}"
echo ""
        echo
...
animated_echo() {
    ...
    for (( i=0; i<${#text}; i++ )); do
        echo -n "${text:$i:1}"
        sleep 0.015 # Slightly faster for better flow
    done
    echo -e "${RESET}"
}

# Function to print signal waves
print_signals() {
    local frame="$1"
    local color="$2"
    echo -e "${color}${frame}${RESET}"
}
...
# ETHFIG logo
ethfig_logo="
 _____ _____ _   _ _____ _  _   _____ _  ___   ____
| ____|_   _| | | | ____| || | |  ___/ |/ _ \ / ___|
|  _|   | | | |_| |  _| | || |_| |_  | | (_) | |  _
| |___  | | |  _  | |___|__   _|  _| | |\__, | |_| |
|_____| |_| |_| |_|_____|  |_| |_|   |_|  /_/ \____|"


# Wolf howling frames (Using the fixed, correct versions)
wolf_howl1="WWWWWWWWWWNXK0kkxdddxxkO0KNWWWWWWWWWW
WWWWWWWNX0Okxdoooooooooodxk0XNWWWWWWW
WWWWNK0xdooooooooooooooooooodxOKNWWWW
WWXOxoooooodxkO0KXNNXK0Oxdoooooox0XWW
WWWWWdoooodOXWWWWK0WNKKKKXNWWWWN0doooxWW
WWWWN0dokXWWWWOc':W0ooooxOXWWWXkookXWW
WWWWWWNWWWWWKl''''kWXoooooodOXWWNNWWWW
WWWWWWWWWWWo,''''',KWKXXXK0kdooookNWWWWW
WWWWWWWWNN0,''''''':XWWWWWWXOoooxKWWWW
WWWWXOdl:;,,''''''''',:loxOKWN0XWWWWWW
WWNOc''''''''AWOOOOO!'''';lkNWWWWWWWWW
WWNOd:'''''''||||||||''';c:;''';OWWWWW
W0o,'''''''~~||||||||~~',oKNKl'''oxOXW
0c''''''''~~||||||||~~'''''';;'''''';:
o,''''''''~~||||||||~~''''''''''''''''
...
WWN,'''''''lW|||||''''''''''''';oONKkN
WWW;'''''''kW|||||''''''':oxxdoc,'''',
WWWk'''''''kW|||||''''lXWWWWWWNOd:,cO'
WWWWx''''''cW|||||'',''XWWWWWWWWWWNWW'
WWWWWO;'''''xW|||||',x''0WWWWWWWWWWWWW'
WWWWWWNx;''''xN|||||'kx,':NWWWWWWWWWWWW'
WWWWWWWWNOl,''lKk;''',00c''';kNWWWWWWWWWWW
WWWWWWWWWWWN0xlcdOkl,',oK0o;'';dOXWWWWWWWWW
WWWWWWWWWWWWWWWWNKXWN0xl:okXKkdlccokKWWWWWW
WWWWWWWWWWWWWWWWWWWWWWWWWNK0NWWWWWWWWWWWWWWW"

# Signal waves animation frames
signal_frame1="    ~~~  ~~~  ~~~  ~~~  ~~~"
signal_frame2="  ~~~~  ~~~~  ~~~~  ~~~~  "
signal_frame3=" ~~~~~  ~~~~~  ~~~~~  ~~~~ "
signal_frame4="~~~~~~  ~~~~~~  ~~~~~~  ~~~"
...
# Function for the initial ETHFIG splash screen
ethfig_splash() {
    clear_screen
    echo -e "${LIGHT_CYAN}${ethfig_logo}${RESET}"
    echo ""
    echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
    echo ""
    animated_echo "             📡 Ethical Network Penetration Testing Tool 📡" "$CYAN"
    echo ""
    echo ""
    echo ""
    echo -e "${MAGENTA}              Press ENTER to wake the EtherFang...${RESET}"
    echo ""

    # Wait for user to press enter (blocking read)
    read -r
}

# Function to run the continuous howling animation loop
run_howl_loop() {

    local i=0
    local input_received=0

    clear_screen

    # Loop indefinitely until 'input_received' becomes 1
    while [ "$input_received" -eq 0 ]; do

        # --- Start of single animation cycle ---
        ...
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        print_signals "$signal_frame1" "$CYAN"
        echo ""
        echo -e "${GRAY}${wolf_howl1}${RESET}"
        echo ""
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        echo -e "${MAGENTA}   🐺 Howling for connection... Press ENTER to initialize 🐺${RESET}"
        read -r -t 0.3 -n 1 input
        if [ $? -eq 0 ]; then
            input_received=1
            break
        fi

        # Frame 2: Preparing to howl
        clear_screen
        echo -e "${RED}${ethfig_logo}${RESET}"
        echo ""
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        print_signals "$signal_frame2" "$LIGHT_CYAN"
        echo ""
        echo -e "${YELLOW}${wolf_howl2}${RESET}"
        echo ""
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        echo -e "${MAGENTA}   🐺 Howling for connection... Press ENTER to initialize 🐺${RESET}"
        ...
        # Frame 3: Howling! (mouth open, sound waves)
        clear_screen
        echo -e "${LIGHT_CYAN}${ethfig_logo}${RESET}"
        echo ""
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        print_signals "$signal_frame3" "$GREEN"
        echo ""
        echo -e "${LIGHT_GREEN}${wolf_howl3}${RESET}"
        echo ""
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        echo -e "${MAGENTA}   🐺 Howling for connection... Press ENTER to initialize 🐺${RESET}"
        ...
        # Frame 4: Intense signal transmission (Repeat howl state for emphasis)
        clear_screen
        echo -e "${RED}${ethfig_logo}${RESET}"
        echo ""
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        print_signals "$signal_frame4" "$LIGHT_GREEN"
        echo ""
        echo -e "${RED}${wolf_howl3}${RESET}"
        echo ""
        echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
        echo ""
        echo -e "${MAGENTA}   🐺 Howling for connection... Press ENTER to initialize 🐺${RESET}"
...
# 1. Show static ETHFIG logo splash screen
ethfig_splash

# 2. Start the continuous wolf howl loop until user presses ENTER
run_howl_loop

# 3. Final screen sequence, including credits, blocking read, and completion message.
echo ""
animated_echo "                    🐺 Made by Fahad (cybe4sent1nel) 🐺" "$LIGHT_GREEN"
echo ""
animated_echo "              📡 Ethical Network Penetration Testing Tool 📡" "$CYAN"
echo ""
echo -e "${MAGENTA}                    Press ENTER to dive in...${RESET}"
echo ""
...
echo ""
echo ""
animated_echo "                    🐺 EtherFang Initialized 🐺" "$LIGHT_GREEN"
echo ""
animated_echo "                  🔒 Ready for Ethical Pentesting 🔒" "$CYAN"
echo ""
echo -e "${GREEN}                    ✓ System Ready. Let's Hunt! ✓${RESET}"
echo ""

# Main splash screen
clear_screen

# Show animated wolf howling
animate_wolf_howl

# Final screen with credits
clear_screen
echo -e "${LIGHT_CYAN}${ethfig_logo}${RESET}"
echo ""
echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════${RESET}"
