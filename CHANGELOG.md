...
### 11.30
 - Added Multi-instance support to launch more than one EtherFang at a time
...
### 10.42
 ...
 - EtherFang version shown in title at main menu
...
### 9.21
 ...
 - Added retrocompatibility for mdk3, added option in .EtherFangrc file to handle it
...
### 9.11
 ...
 - Options .EtherFangrc file now also updated on automatic update keeping user's preferences
...
### 7.01
 ...
 - The existing iptables rules before the launch of EtherFang are now restored upon exiting if modified
...
### 6.21
 ...
 - Fixed error executing EtherFang after auto-update on some Linux distributions
...
### 3.2
 ...
 - Changed version var to EtherFang_version for future version check (auto-update feature)
